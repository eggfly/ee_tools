...
R_VALUES_5_PERCENT = (10, 11, 12, 13, 15, 16, 18, 20, 22, 24, 27, 30, 33, 36, 39, 43, 47, 51, 56, 62, 68, 75, 82, 91, 100, 110, 120, 130, 150, 160, 180, 200, 220, 240, 270, 300, 330, 360, 390, 430, 470, 510, 560, 620, 680, 750, 820, 910, 1000, 1100.0, 1200.0, 1300.0, 1500.0, 1600.0, 1800.0, 2000, 2200.0, 2400.0, 2700.0, 3000.0, 3300.0, 3600.0, 3900.0, 4700.0, 5100.0, 5600.0, 6200.0, 6800.0, 7500.0, 8200.0, 9100.0, 10000, 11000, 12000, 13000, 15000, 16000, 18000, 20000, 22000, 24000, 27000, 30000, 33000, 36000, 39000, 43000, 47000, 51000, 56000, 62000, 68000, 75000, 82000, 91000, 100000, 110000, 120000, 130000, 150000, 160000, 180000, 200000, 220000, 240000, 270000, 300000, 330000, 360000, 390000, 430000, 470000, 560000, 620000, 680000, 750000, 820000, 910000, 1000000.0, 1500000.0, 2200000.0)

# CHANGE THIS
R_VALUES = R_VALUES_5_PERCENT

R_VALUES = (
    2*K,1*K,100*K,10*K,12*K,15*K,200*K,20*K,1000*K,5.1*K,4.7*K,3.3*K,2.2*K,1.5*K,51*K,47*K,33*K,22*K,
    510*K,150,300,680,120*K,150*K,75*K,56*K,470*K,39*K,330*K,300*K,27*K,24*K,220*K,18*K,10*M,3.9*K,68*K,8,2*K,7.5*K,6.8*K,5.6*K,49.9*K,2.4*K,1.2*K,
)
