...
def get_jlc_session(packaging: str, pageNum: int):
    s = requests.Session()  
...
def query_from_jlc():
    ...
    results += get_component_list('0603')
    results += get_component_list('0402')
    return results
...
def parse_result(data_list):  
    ...
    for item in data_list:  
        ...
        if 'Ω' in name:
            ...
            info = {'value': r_val, 'code':code, 'full': full_str}
            values.append(info)
            print(info)
    ...
    for v1 in values:
        ...
        for v2 in values:
            ...
            if match_v_out(v_out) and match_extra(r2):
                ...
                # noinspection SpellCheckingInspection
                print(
                    "R1 = {:.0f}Ω {} {}, R2 = {:.0f}Ω {} {}, Vout = {:.3f} V, Current = {:.3f} μA".format(r1, code1, full_str1, r2, code2, full_str2,
