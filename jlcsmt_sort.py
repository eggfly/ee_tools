...
def query_from_jlcsmt():
    ...
    body = '''{"ascFlag":true,"baseQueryDto":{"componentBrandList":[],"componentSpecificationList":[],"componentTypeIdList":[545],"preferredComponentFlagList":[],"orderLibraryTypeList":[],"packageTypeList":[],"productTypeIdList":[365],"inStockFlag":true},"groupFlag":false,"pageVo":{"pageNum":1,"pageSize":10},"paramDtoList":[{"paramName":"间距","paramValueList":["0.5mm"]},{"paramName":"触点数量","paramValueList":["14","14P"]}],"queryString":"","sortMode":"COMPREHENSIVE"}'''
    body = '''{"ascFlag":false,"baseQueryDto":{"componentBrandList":[],"componentSpecificationList":[],"componentTypeIdList":[545],"preferredComponentFlagList":[],"orderLibraryTypeList":[],"packageTypeList":[],"productTypeIdList":[365],"inStockFlag":true},"groupFlag":false,"pageVo":{"pageNum":1,"pageSize":10},"paramDtoList":[{"paramName":"间距","paramValueList":["0.5mm"]},{"paramName":"触点数量","paramValueList":["14","14P"]},{"paramName":"触点类型","paramValueList":["双侧触点/上下接"]}],"queryString":"","sortMode":"COMPREHENSIVE"}'''
    body = '''{"ascFlag":false,"baseQueryDto":{"componentBrandList":[],"componentSpecificationList":[],"componentTypeIdList":[11068],"preferredComponentFlagList":["false"],"orderLibraryTypeList":[],"packageTypeList":[],"productTypeIdList":[365],"inStockFlag":true},"groupFlag":false,"pageVo":{"pageNum":1,"pageSize":10},"paramDtoList":[{"paramName":"总PIN数","paramValueList":["4P"]},{"paramName":"间距","paramValueList":["1.25mm"]}],"queryString":"","sortMode":"COMPREHENSIVE"}'''
